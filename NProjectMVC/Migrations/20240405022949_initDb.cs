        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedWorkTime = table.Column<float>(type: "real", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectTaskUser", x => new { x.AssignedMembersId, x.TasksId });
                    table.ForeignKey(
                        name: "FK_ProjectTaskUser_AspNetUsers_AssignedMembersId",
                        column: x => x.AssignedMembersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectTaskUser_ProjectTasks_TasksId",
                        column: x => x.TasksId,
